...
int main()
{
     unsigned char test[SIZE] = { 250, 199, 145, 18, 2,6,114,88,45, 76, 25,23,250, 122,90, 177,244,
                              201,   6,  60,   8, 2, 5,67,7,87,230,3,100, 90};
...
float find_mean (unsigned char *array, unsigned int counter){
  unsigned int accumulator = 0; // to store the accumulator value
  float mean = 0;
  for (int i=0; i<counter; i++){
